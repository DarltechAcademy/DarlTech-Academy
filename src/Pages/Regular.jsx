...
export default function Program() {
  const programs = [
    {
      title: "UI/UX Design",
      duration: "4 Months Basic-Advance",
      price: "₦200,000",
      icon: Palette,
    ...
    },
    {
      ...
      duration: "6 Months Basic-Advance",
      price: "₦250,000",
      icon: Globe,
    ...
    },
    {
      ...
      duration: "6 Months Basic-Intensive",
      price: "₦300,000",
      icon: Smartphone,
    ...
    },
    {
      ...
      duration: "8 Months Basic-Intensive",
      price: "₦350,000",
      icon: Shield,
    ...
    {
      title: "Data Analysis",
      duration: "7 Months Basic-Intensive",
      price: "₦250,000",
      icon: BarChart3,
    ...
    },
    {
      ...
      duration: "4 Months Basic-Intensive",
      price: "₦150,000",
      icon: ClipboardList,
