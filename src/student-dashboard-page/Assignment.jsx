...
import { Calendar, Award, Code, Shield, FileText } from "lucide-react";
        ...
        {sortedAssignments.map((a) => (
          ...
          >
            <div className="flex items-start gap-4">
              <div
                className={`w-14 h-14 rounded-2xl bg-${a.dueColor}-100 flex items-center justify-center flex-shrink-0`}
              >
                {getIcon(a.type)}
              </div>
              <div>
                ...
                <div className="flex items-center gap-4 mt-3 text-sm text-slate-500">
                  <span className="flex items-center gap-1">
                    <Calendar className="w-4 h-4" /> Due {a.dueText}
                  </span>
                  <span className="flex items-center gap-1">
