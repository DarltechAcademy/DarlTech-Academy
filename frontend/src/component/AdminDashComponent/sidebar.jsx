...
const adminMenu = [
  {
    ...
    items: [
      ...
      { name: "Courses", path: "/Admindashboard/courses", icon: BookOpen,   },
      { name: "Assignments", path: "/Admindashboard/assignments", icon: ClipboardCheck, },
  ...
  },
  {
    ...
    items: [
      ...
      // { name: "Messages", path: "/Admindashboard/messages", icon: MessageSquare,  },
            ...
            {group.items.map((item) => {
              ...
              return (
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `relative flex items-center gap-3 p-3 rounded-lg transition-all group ${
                      isActive
